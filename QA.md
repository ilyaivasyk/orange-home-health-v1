...
- Confirmed the supplied MP4 files are present: the hero uses a muted looping background video and Our Services uses a native controlled video with a local poster.
